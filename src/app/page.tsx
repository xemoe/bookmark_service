export default function Home() {
    return (
        <section className="bg-white dark:bg-gray-900 antialiased mt-10 py-10">
            <section className="text-gray-600 body-font bg-white dark:bg-slate-900">
                <div className="container mx-auto flex md:px-24 md:py-10 md:flex-row flex-col items-center">
                    <div
                        className="lg:flex-grow mt-5 md:mt-0   md:w-1.5/2 lg:pr-24 md:pr-16 flex
                        flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <h1 className="mb-3 text-gray-900 dark:text-gray-100 sm:text-4xl">
                            MHTML Bookmark Service
                        </h1>
                        ...
                        <div className="flex justify-center">
                            ...
                            <a href="/about" className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2
                               px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Read articles
                            </a>
                        </div>
                    </div>
                    <div className="lg:max-w-lg lg:w-full mb-5 md:mb-0 md:w-1/2 w-3/6">
                        <img className="object-cover object-center rounded" alt="hero" src="next.svg"/>
                    </div>
                </div>
            </section>
        </section>
